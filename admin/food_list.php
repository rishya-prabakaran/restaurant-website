        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #334FFF;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">MENU ITEMS</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='food_list.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #7D3C98;' >$i</a>  "  : " <a href='food_list.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>

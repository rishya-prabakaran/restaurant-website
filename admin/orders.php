<?php 
	...
	$per_page = 10;
		...
		if($orders->num_rows) {
			...
			$result = "<p style='color:red; padding: 10px; background: #ffeeee;'>No Orders available yet</p>";
...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed" style="background: #334FFF;">
                        ...
                        <div class="card">
							...
							<div class="row">
								...
								<div class="col-md-12" >
									...
									<div class="col-md-3" style="text-align: center; background: #59C55D; color: #fff; border-right: 1px solid #fff;">
									
										<h5>ORDER ID</h5>
										
									</div>
									
									<div class="col-md-9" style="background: #59C55D; color: #fff;">
							...
							<div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='orders.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #7D3C98;' >$i</a>  "  : " <a href='orders.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <?php echo strftime("%Y", time()); ?> <a href="index.php" style="color: #334FFF;">FooDelicious</a>
                </p>
            </div>
        </footer>
